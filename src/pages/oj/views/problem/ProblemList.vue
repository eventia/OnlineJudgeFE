<template>
  <Row type="flex" :gutter="18">
          ...
          <li>
            <Dropdown @on-click="filterByDifficulty">
              ...
              <Dropdown-menu slot="list">
                ...
                <Dropdown-item name="Low">기초</Dropdown-item>
                <Dropdown-item name="Mid">알고리즘1단계</Dropdown-item>
                <Dropdown-item name="High">알고리즘2단계</Dropdown-item>
              </Dropdown-menu>
            </Dropdown>
          </li>
          <li>
    ...
    <Col :span="5">
    <Panel :padding="10">
      <div slot="title" class="taglist-title">태그</div>
